...
{
       0,   126,   126,   130,   131,   132,   136,   137,   138,   142,
     143
};
#endif
...
yyreduce:
  ...
  case 2: /* input: expr  */
#line 126 "parser.y"
         { printf("DAG generated. In-order traversal:\n"); printDAG((yyvsp[0].node)); clearSubexprMap(); printf("\n"); }
#line 1180 "parser.tab.c"
    break;

  case 3: /* expr: expr PLUS term  */
#line 130 "parser.y"
                   { (yyval.node) = getOrCreateNode('+', (yyvsp[-2].node), (yyvsp[0].node), 0); }
...
#line 143 "parser.y"
             { (yyval.node) = getOrCreateNode('\0', NULL, NULL, (yyvsp[0].intVal)); }
